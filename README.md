...
| 編號 | 檔案 | 用途 | 對應課次 |
|------|------|------|---------|
| #00 | [環境建置](./00-環境建置%20(1).md) | 安裝 Git、gh、uv、winget | 第 4–5 課 |
| #01 | [連接 NotebookLM](./01-連接-NotebookLM%20(1).md) | 安裝 nlm、登入 Google、MCP 設定 | 第 6–8 課 |
| #08 | [安裝 FB 頻道摘要 Skill](./08-安裝FB頻道摘要Skill%20(1).md) | 安裝 SKILL.md、測試互動 | 第 9 課 |

## 輔助資源

| 檔案 | 說明 |
|------|------|
| [新手安裝指南](./00-新手安裝指南%20(1).md) | 從零開始安裝 OpenCode（含 API Key 申請） |
